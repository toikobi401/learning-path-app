      ...
      <div
        className={`max-w-[80%] rounded-2xl px-4 py-3 text-sm leading-relaxed ${
          isUser
            ...
            : "rounded-bl-sm bg-white text-gray-800 ring-1 ring-gray-200 dark:bg-gray-800 dark:text-gray-200 dark:ring-gray-700"
        }`}
      >
        {message.content}
      </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
              Ask questions about your learning path and get personalised guidance.
            </p>
          </div>
          {messages.length > 0 && (
            <button
              ...
              className="rounded-md border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-500 transition hover:bg-gray-50 disabled:opacity-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800"
            >
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              Create a goal first to start chatting.
            </p>
            <Link
              href="/dashboard/goals/new"
              className="mt-4 inline-block rounded-md bg-gray-900 px-4 py-2 text-sm font-semibold text-white hover:bg-gray-700 dark:bg-gray-100 dark:text-gray-900"
            >
              Create goal
            </Link>
          </div>
        ...
        <>
          ...
          <div className="mb-4 flex-none">
            <select
              ...
              className="w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:focus:ring-gray-100"
            >
              {goals.map((g) => (
              ...
              <div className="flex h-full flex-col items-center justify-center gap-3 text-center">
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-xs text-xs text-gray-500 dark:text-gray-400">
                    Ask about topics in &ldquo;{selectedGoal?.title}&rdquo;, study
                    strategies, or anything related to your goal.
                  </p>
                </div>
                <div className="flex flex-wrap justify-center gap-2">
                  {[
                    ...
                    <button
                      ...
                      className="rounded-full border border-gray-200 px-3 py-1.5 text-xs text-gray-600 transition hover:bg-white dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800"
                    >
                      {prompt}
                    </button>
                  ))}
          ...
          <div className="mt-3 flex-none">
            <div className="flex items-end gap-2 rounded-lg border border-gray-200 bg-white p-2 dark:border-gray-700 dark:bg-gray-900">
              <textarea
                ...
                rows={1}
                className="flex-1 resize-none bg-transparent px-2 py-1.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none dark:text-gray-100 dark:placeholder-gray-500"
                style={{ maxHeight: "120px" }}
              />
              <button
                onClick={sendMessage}
                disabled={!input.trim() || sending}
                className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-gray-900 text-white transition hover:bg-gray-700 disabled:opacity-40 dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-300"
              >
            ...
            <p className="mt-1.5 text-right text-xs text-gray-400 dark:text-gray-600">
