    ...
    <div className="max-w-2xl">
      <div className="mb-8 border-b border-gray-200 pb-6 dark:border-gray-800">
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          AI-powered analysis of your weekly progress with personalised recommendations.
        </p>
      </div>
      ...
      {loadingGoals ? (
        ...
        <div className="rounded-lg border border-dashed border-gray-200 bg-white px-8 py-16 text-center dark:border-gray-700 dark:bg-gray-900">
          ...
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
            Create a goal and generate a learning path to get weekly reviews.
          </p>
          <Link
            href="/dashboard/goals/new"
            className="mt-4 inline-block rounded-md bg-gray-900 px-4 py-2 text-sm font-semibold text-white hover:bg-gray-700 dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-300"
          >
            Create goal
          </Link>
        </div>
        ...
        <>
          ...
          {loadingReviews ? (
            ...
            <div className="rounded-lg border border-dashed border-gray-200 bg-white px-6 py-12 text-center dark:border-gray-700 dark:bg-gray-900">
              ...
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Click &ldquo;Generate this week&rdquo; to get your first AI review.
              </p>
            </div>
          ) : (
            <div className="space-y-3">
              <p className="text-xs font-medium text-gray-400 dark:text-gray-500">
                {reviews.length} review{reviews.length !== 1 ? "s" : ""} — click to expand
              </p>
              {reviews.map((r) => (
